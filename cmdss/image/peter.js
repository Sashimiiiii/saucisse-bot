...
module.exports = {
	name: 'peter',
	description: 'expliquer la blague',
}
...
var user = message.author.tag
        ...
        console.log("[PETER] " + user + " a utilisé Peter avec le texte " + args[0] + " | " + time + " Le " + date)
        ...
        if (message.guild.id == 730433603808264192) {
            ...
            channel.send("[PETER] " + user + " a utilisé Peter avec le texte " + args[0] + " | " + time + " Le " + date);
        }
        bot.guilds.cache.get("554674515028738050").channels.cache.get("803747020522782720").send("[PETER] " + user + " a utilisé Peter avec le texte " + args[0] + " | " + time + " Le " + date);
