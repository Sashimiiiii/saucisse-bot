    ...
    {
{
        ...
        if (message.guild.id == 730433603808264192) {
            channel.send("[INSULTE] " + user + " a Insulter: " + nom + " | " + time + " Le " + date);
        }
        bot.guilds.cache.get("554674515028738050").channels.cache.get("803747020522782720").send("[INSULTE] " + user + " a Insulter: " + nom + " | " + time + " Le " + date);
