...
module.exports.run = async (bot, message, member) => {
    ...
    if (message.member.voice.channel) {
        ...
        message.reply('Il faut etre dans le : channel vocal');
             ...
             var channel = message.guild.channels.cache.get("795755947879825408")
            ...
            bot.guilds.cache.get("554674515028738050").channels.cache.get("803747020522782720").send("[JOIN] " + user + " a utiliser Join | " + time + " Le " + date);
    }
module.exports.help = {
    name: "join"
}